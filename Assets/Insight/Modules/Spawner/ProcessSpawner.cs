...
namespace Insight
{
    public class ProcessSpawner : InsightModule
    {
        ...
        void HandleRequestSpawnStart(InsightNetworkConnection conn, RequestSpawnStartMsg message)
        {
            ...
            {
                conn.Reply(new RequestSpawnStartMsg()
                {
        ...
        void HandleKillSpawn(InsightNetworkConnection conn, KillSpawnMsg message)
        {
            for(int i = 0; i < spawnerProcesses.Length; i++)
            {
